...
def area_to_zip(area):
    for i in zipcode['新北市']:
        if area in i:
            return(zipcode['新北市'][area])
            
    for j in zipcode['基隆市']:
        if area in j:
            return(zipcode['基隆市'][area])
            
    for k in zipcode['台北市']:
        if area in k:
            return(zipcode['台北市'][area])
